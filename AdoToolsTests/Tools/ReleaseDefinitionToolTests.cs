...
namespace DevOpsTools.UnitTests.Tools
{
    ...
    public class ReleaseToolTests
    {
        ...
        private ReleaseDefinitionTool _fakeTool;
        ...
        {
            const string name = "HP-PROD-TOKEN";
        ...
        public static void GetId_ReturnsExpectedResult()
        {
            ...
            var result = realTool.GetId("HP-PROD-TOKEN").Result;
        ...
        private static ReleaseDefinitionTool MakeRealTool()
        {
            var pat = ToolHelper.GetPersonalAccessToken();
            var client = new Client(pat);
            return new ReleaseDefinitionTool(client, TestHelper.RealOrganization, TestHelper.RealProject);
        }
    }
}